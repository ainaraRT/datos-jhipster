...
import { ExperienciaComponent } from 'app/entities/experiencia/experiencia.component';
...
describe('Component Tests', () => {
  describe('Experiencia Management Component', () => {
    let comp: ExperienciaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExperienciaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.experiencias[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
